...
**
** Created: Sat Apr 24 19:02:16 2010
...
static const char qt_meta_stringdata_quitDialog[] = {
    "quitDialog\0"
};

const QMetaObject quitDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_quitDialog,
      qt_meta_data_quitDialog, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_quitDialog))
