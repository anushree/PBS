...
**
** Created: Mon May 3 09:04:00 2010
...
static const char qt_meta_stringdata_entryDialog[] = {
    "entryDialog\0\0showSheet()\0"
};

const QMetaObject entryDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_entryDialog,
      qt_meta_data_entryDialog, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_entryDialog))
